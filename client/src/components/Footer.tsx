      ...
      <div className="container-px grid gap-10 py-14 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-ink-400">
            India's smart platform to discover exhibitions, explore exhibitors and book stalls in real time — all in one place.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-ink-400">
            <li className="flex items-start gap-2.5"><MapPin width={17} className="mt-0.5 shrink-0 text-brand-400" /> Venues across Bengaluru, Mumbai, Delhi & more</li>
            <li className="flex items-center gap-2.5"><Phone width={17} className="text-brand-400" /> +91 80 4000 0000</li>
            <li className="flex items-center gap-2.5"><Mail width={17} className="text-brand-400" /> hello@expomela.com</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10 py-5 text-center text-xs text-ink-500">
        © {new Date().getFullYear()} Expo Mela (expomela.com) — demo exhibition & stall booking platform. Built with React + Turso.
      </div>
    </footer>
  );
}
