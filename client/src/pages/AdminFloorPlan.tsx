  ...
  return (
    <div className="container-px py-8">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900">Floor Plan Manager</h1>
          <p className="text-sm text-slate-500">Update stall status live — available, reserved, booked, sponsor or blocked.</p>
        </div>
