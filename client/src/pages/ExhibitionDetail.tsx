...
const TABS = ['Overview', 'Floor Plan', 'Exhibitors', 'Seminars', 'Gallery', 'FAQs'] as const;
        ...
        <div className="py-8">
          ...
          {tab === 'Gallery' && (
            <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
              {data.gallery.map((g, i) => <img key={i} src={g} alt="" className="h-48 w-full rounded-xl object-cover" />)}
            </div>
          )}
          ...
          {tab === 'FAQs' && (
            <div className="mx-auto max-w-2xl space-y-3">
              {[
                { q: 'How do I book a stall?', a: 'Open the Floor Plan tab, click any green (available) stall, fill your company details and confirm — it books instantly.' },
